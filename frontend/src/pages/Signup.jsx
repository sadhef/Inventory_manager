...
import { Mail, Lock, User, Package, ArrowRight, Eye, EyeOff, Check } from 'lucide-react';
          ...
          <div className="mt-12 grid grid-cols-1 gap-4 w-full max-w-sm">
            <div className="bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-sm font-semibold text-blue-100">Free to start</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="hidden lg:block text-center">
            ...
            <p className="text-gray-600">Join thousands of businesses managing their inventory</p>
          </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 h-12 text-base ${formErrors.name 
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 pr-12 h-12 text-base ${formErrors.confirmPassword 
                        ? 'border-red-400 focus:border-red-500 focus:ring-red-200' 
                        : 'border-gray-300 focus:border-blue-500 focus:ring-blue-200'
                      } focus:ring-2 transition-colors`}
                    />
